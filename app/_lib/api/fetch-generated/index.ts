...
export type ListWorkouPlansParams = {
  active?: ListWorkouPlansActive;
};

export type ListWorkouPlansActive =
  (typeof ListWorkouPlansActive)[keyof typeof ListWorkouPlansActive];

export const ListWorkouPlansActive = {
  true: "true",
  false: "false",
} as const;

export type ListWorkouPlans200ItemWorkoutDaysItemWeekDay =
...
export type ListWorkouPlans200ItemWorkoutDaysItem = {
  id: string;
  name: string;
  weekDay: ListWorkouPlans200ItemWorkoutDaysItemWeekDay;
  isRest: boolean;
  estimatedDurationInSeconds: number;
  coverImageUrl?: string;
  exercises: ListWorkouPlans200ItemWorkoutDaysItemExercisesItem[];
};

export type ListWorkouPlans200Item = {
  id: string;
  name: string;
  isActive: boolean;
  workoutDays: ListWorkouPlans200ItemWorkoutDaysItem[];
};

export type ListWorkouPlans401 = {
  error: string;
  code: string;
};

export type ListWorkouPlans500 = {
  error: string;
  code: string;
};
...
export type UpdateWorkoutSession422 = {
  error: string;
  code: string;
};
 ...
 */
export type listWorkouPlansResponse200 = {
  data: ListWorkouPlans200Item[];
  status: 200;
};

export type listWorkouPlansResponse401 = {
  data: ListWorkouPlans401;
  status: 401;
};

export type listWorkouPlansResponse500 = {
  data: ListWorkouPlans500;
  status: 500;
};

export type listWorkouPlansResponseSuccess = listWorkouPlansResponse200 & {
  headers: Headers;
};
export type listWorkouPlansResponseError = (
  | listWorkouPlansResponse401
  | listWorkouPlansResponse500
) & {
  headers: Headers;
};

export type listWorkouPlansResponse =
  | listWorkouPlansResponseSuccess
  | listWorkouPlansResponseError;

export const getListWorkouPlansUrl = (params?: ListWorkouPlansParams) => {
...
export const listWorkouPlans = async (
  params?: ListWorkouPlansParams,
  options?: RequestInit,
): Promise<listWorkouPlansResponse> => {
  return customFetch<listWorkouPlansResponse>(getListWorkouPlansUrl(params), {
    ...options,
    method: "GET",
  });
};
...
export type updateWorkoutSessionResponse422 = {
  data: UpdateWorkoutSession422;
  status: 422;
};
...
export type updateWorkoutSessionResponseError = (
  ...
  | updateWorkoutSessionResponse422
