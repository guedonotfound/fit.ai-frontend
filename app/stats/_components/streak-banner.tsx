  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-6 overflow-hidden rounded-xl px-5 py-10">
      ...
      <div className="relative flex flex-col items-center gap-3">
        <div className="rounded-full border border-background/12 p-3 backdrop-blur-[4px]">
          <Flame className="size-8 text-background" />
        </div>
        <div className="flex flex-col items-center gap-1">
          <p className="font-heading text-5xl font-semibold text-background leading-[0.95]">
            {workoutStreak} dias
          </p>
